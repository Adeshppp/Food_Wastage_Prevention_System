...
#define FIREBASE_HOST "firebase host url"//to give data to node mcu
#define FIREBASE_HOST1 " firebase host url" //to get data from nodemcu... 
#define FIREBASE_AUTH1 "authentication key for firebase host 1"
#define FIREBASE_AUTH "authentication key for firebase host"
